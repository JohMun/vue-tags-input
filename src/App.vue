<template>
  <div ref="app" id="app">
    ...
    <main>
      <div class="content">
        <header>
          <div class="menu-toggle"><i class="material-icons" @click="navVisible = true">menu</i></div>
          <div>
            <a class="gt-link" href="https://github.com/JohMun/vue-tags-input" target="_blank">
              <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 438.549 438.549" style="enable-background:new 0 0 438.549 438.549;"
                xml:space="preserve">
                <g>
